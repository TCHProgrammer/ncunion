...
/* @var $model common\models\object\AttributeCheckbox */
...
$this->params['breadcrumbs'][] = ['label' => 'Дополнительные атрибуты: список', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="attribute-checkbox-create">
