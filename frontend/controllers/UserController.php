...
class UserController extends DefaultFrontendController
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'allow' => true,
                        'roles' => ['unknown', 'no_pay', 'investor', 'admin', 'broker'],
                        'actions' => ['profile', 'settings', 'update-password']
                    ],
                    [
                        'allow' => true,
                        'actions' => ['create-passport', 'passport'],
                        'roles' => ['access_menu_passport'],
                    ]
                ],
    ...
    public function actionPassport()
    {
        ...
        if (is_null($user->user_passport_id)) {
            return $this->redirect('create-passport');
        }
    ...
    public function actionCreatePassport()
    {
